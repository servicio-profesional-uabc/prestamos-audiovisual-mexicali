...
Para instalar PEMA y configurar el entorno de desarrollo, sigue las instrucciones detalladas que se encuentran [aquí](https://github.com/servicio-profesional-uabc/prestamos-audiovisual-mexicali/wiki).
