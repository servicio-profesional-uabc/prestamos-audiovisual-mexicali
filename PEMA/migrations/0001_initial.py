    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion', models.TextField(default='', max_length=512, verbose_name='Descripción de la Producción')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lugar', models.CharField(choices=[('CA', 'En el Campus'), ('EX', 'Fuera del Campus')], default='CA', max_length=2, verbose_name='Lugar de la Producción')),
                ('descripcion_lugar', models.CharField(max_length=125, null=True, verbose_name='Lugar Especifico')),
                ('estado', models.CharField(choices=[('RS', 'Pendiente'), ('EN', 'Entregada'), ('CN', 'Cancelada'), ('AP', 'Listo para iniciar'), ('DE', 'Devuelta')], default='RS', max_length=2)),
                ('inicio', models.DateTimeField()),
                ('final', models.DateTimeField()),
                ('descripcion', models.TextField(max_length=512, verbose_name='Descripción de la Producción')),
                ('emision', models.DateTimeField(auto_now_add=True)),
                ('_corresponsables', models.ManyToManyField(related_name='corresponsables', to=settings.AUTH_USER_MODEL, verbose_name='Participantes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('numero_telefono', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, region='MX')),
