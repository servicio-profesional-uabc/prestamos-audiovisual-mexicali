    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descripcion_lugar', models.CharField(max_length=125, null=True, verbose_name='Lugar Específico')),
                ...
                ('_articulos', models.ManyToManyField(blank=True, through='PEMA.ArticuloCarrito', to='PEMA.articulo')),
                ('_corresponsables', models.ManyToManyField(blank=True, related_name='corresponsables_carrito', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre', models.CharField(max_length=250, verbose_name='Nombre Producción')),
                ('tipo', models.CharField(choices=[('OR', 'Ordinaria'), ('EX', 'Extraordinaria')], default='OR', max_length=2, verbose_name='Tipo de Solicitud')),
                ('lugar', models.CharField(choices=[('CA', 'En el Campus'), ('EX', 'Fuera del Campus')], default='CA', max_length=2, verbose_name='Lugar de Producción')),
                ('descripcion_lugar', models.CharField(max_length=125, null=True, verbose_name='Lugar Específico')),
                ('estado', models.CharField(choices=[('RS', 'Pendiente'), ('CN', 'Cancelada'), ('AP', 'Listo para iniciar'), ('EN', 'Entregada'), ('DE', 'Devuelta')], default='RS', max_length=2)),
                ('inicio', models.DateTimeField()),
                ('final', models.DateTimeField()),
                ('descripcion', models.TextField(max_length=512, verbose_name='Descripción de la Producción')),
                ('emision', models.DateTimeField(auto_now_add=True)),
                ('_corresponsables', models.ManyToManyField(related_name='corresponsables', through='PEMA.CorresponsableOrden', to=settings.AUTH_USER_MODEL, verbose_name='Participantes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('orden', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='PEMA.orden')),
                ('emision', models.DateTimeField(auto_now_add=True)),
                ('entregador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='PEMA.almacen')),
            ],
        ),
