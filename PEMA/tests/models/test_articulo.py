...
class TestArticulo(TestCase):
    ...
    def setUp(self):
        ...
        self.articulo = Articulo.objects.create(nombre="articulo 1", codigo="codigo 1")

        self.unidad, _ = self.articulo.crear_unidad(num_control="num_control 1", num_serie="num_series 2")
        ...
        self.unidad1, created = self.articulo1.crear_unidad(num_control="1", num_serie="1")
        self.unidad2, created = self.articulo1.crear_unidad(num_control="2", num_serie="2")
        self.unidad3, created = self.articulo1.crear_unidad(num_control="3", num_serie="3")
        self.unidad4, created = self.articulo1.crear_unidad(num_control="4", num_serie="4")
        self.unidad5, created = self.articulo2.crear_unidad(num_control="5", num_serie="5")
        self.unidad6, created = self.articulo2.crear_unidad(num_control="6", num_serie="6")
        self.unidad7, created = self.articulo2.crear_unidad(num_control="7", num_serie="7")
        self.unidad8, created = self.articulo2.crear_unidad(num_control="8", num_serie="8")
